...
local AoE = {
	...
	{"Execute", "player.buff(Shattered Defenses) & target.health <= 20 & !isdummy"},								-- Execute (if Shattered Defense is up)
...
local Execute = {
	...
	{"Execute", "player.buff(Battle Cry) & !isdummy"},																-- Execute during Battle Cry
	{"Colossus Smash", "!player.buff(Shattered Defenses)"}, 											-- Colossus Smash
...
local ST = {
	...
	{"Execute", "player.buff(Ayala's Stone Heart) & !isdummy"}, 													-- execute with legendary
