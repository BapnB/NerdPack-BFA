...
local Cooldowns = {
	...
	{"Dark Arbiter", "inRange.spell & canAttack & talent(7,1)", "target"},
...
local Combat = {
	...
	{"Clawing Shadows", "inRange.spell & debuff(Festering Wound).count >= 1 & debuff(Soul Reaper)", "target"},
	{"Scourge Strike", "inRange.spell & debuff(Festering Wound).count >= 1 & debuff(Soul Reaper)", "target"},
	...
	{"Scourge Strike", "inRange.spell & canAttack & infront & player.area(10).enemies > 2 & spell(Death and Decay).cooldown >= 20", "target"},
	...
	{"Scourge Strike", "inRange.spell & {target.debuff(Scourge of Worlds) & spell(Soul Reaper).cooldown >= 3 || target.debuff(Festering Wound).count >= 3} & {spell(Apocalypse).cooldown > 4 || !toggle(cooldown)}", "target"},
